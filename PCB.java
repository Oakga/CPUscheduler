...
public class PCB implements Comparable<PCB>{
  ...
  public int compareTo(PCB object) {
		if(this.cpuBursts[(this.currentBurst)]==object.cpuBursts[object.currentBurst])return 0;
		else if(this.cpuBursts[(this.currentBurst)]<object.cpuBursts[object.currentBurst]) return -1;
		else return 1;
	}
}
